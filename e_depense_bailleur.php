...
<html>
	...
	<body style="background-image: url(<?= $image ?>bgaccueil.jpg);">
		...
		<div class="row">
			<h3 class="center col s12 white-text" >Nouvelle dépenses</h3>
			<h4 class="center col s12 white-text" >Veillez sélectionner le bailleur pour effectuer la dépense</h4>
