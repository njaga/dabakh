...
$req_annee=$db->query('SELECT DISTINCT YEAR(date_ravitaillement) FROM `ravitaillement_consommable`');
...
<html>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			$('.tooltipped').tooltip();
			function l_ravitaillement_consommable_ajax(mois, annee,search)
			{
				$.ajax({
				type:'POST',
				url:'l_ravitaillement_consommable_ajax.php',
			...
			l_ravitaillement_consommable_ajax(mois, annee,search);
