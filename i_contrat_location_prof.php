...
$type_logement = $donnees['17'];

$nbr_mois = $caution / $pu;
$nbr_mois = ceil($nbr_mois);
...
<body style="background-image: url(<?= $image ?>i_mensualite.png);">
    ...
    <div class="container white">
        <div class="row center white" style="margin-bottom: 1px">
            ...
            <p class="col s6 left-align" style="font-family: 'times new roman'; font-size: 14px">Imprimé le <?= $date_actuelle ?></p>
        </div>
        <div class="row">
            ...
            <div class="col s12" style="font: 12pt 'times new roman';">
                ...
                <br>
                <br>
                <b><?= $bailleur ?></b> représenté par la <b>Société Carré d'Or SAS</b> inscrite au RCCM sous le <b>N° SN-DKR-2023-B-8664</b>, prise en la personne de son représentant légal, <b>Madame Adama DIOP</b> la Directrice Générale
                <br>
            ...
            <div class="col s12">
                ...
                <br>
                Le bailleur donne bail à loyer pour le temps aux charges et conditions au preneur qui accepte un <b><?= $designation_logement ?></b> situé à <b><?= $adresse ?></b>.
                <br>
                ...
                <br>
                Le bailleur pourra s’opposer au renouvellement du bail s’il justifie d’un motif grave et légitime à l’encontre du preneur sans aucune indemnité. Lorsque le bail est rompu dans des conditions qui donnent droit à l’indemnité d’éviction, les parties ont décidé de fixer d’avance ladite indemnité à la somme de <b><?= $pu +$tom + $tva ?></b> F CFA.
                <br>
                ...
                <br>
                La location est consentie au prix de <b><?= $pu +$tom + $tva ?></b> F CFA TTC (comme détaillé ci-dessous), payable par terme mensuel et d’avance au plus trad le 05 de chaque mois entamé
                <br>
                <br>
                <div class="row">
                    <table class=" ">
                        ...
                        <tr>
                            <td>TOM 3.6%</td>
                            <td><b><?= $tom ?></b> F/mois</td>
                        </tr>
                            <td>TVA 18%</td>
                            <td><b><?= $tva ?></b> F/mois</td>
                        </tr>
                        <tr>
                            <td>Total loyer TTC</td>
                            <td><b><?= $pu +$tom + $tva ?></b> F/mois</td>
                        </tr>
                    </table>
                </div>
                <br>
                <br>
                Le loyer est payable dans les bureaux de la Société Carré d'Or SAS ayant son siège social à la cité Keur Gorgui. Tout mois commencé est dû dans son intégralité.
                <br>
                ...
                <b><u>ARTICLE 4 : OBLIGATIONS DES PARTIES</u></b>
                <br>
                ...
                <br>
                <br>
                <b>e- Obligations d’assurances</b>
                <br>
                Le preneur contractera auprès d’une compagnie assurance agrée, une police d’assurance contre l’incendie, les dégâts des eaux couvrant ses biens propres, les risques locatifs et de voisinages.
                <br>
                Il s’acquittera du paiement de cette prime d’assurance et devra présenter la quittance correspondante au bailleur sur simple demande de celui-ci.
                <br>
                <br>
                <b> f- Paiement de factures et des charges locatives</b>
                <br>
                ...
                <br>
                <br>
                <b><u>ARTICLE 5 : CAUTION. </u></b>
                <br>
                Une somme de <b><?= $caution * 2?></b> F CFA équivalente à <b><?= $nbr_mois ?></b> mois de loyer TTC devra être versée par le preneur à titre de caution du contrat de bail contre quittance.
                <br>
                <br>
