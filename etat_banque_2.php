            ...
            <div class="col s12   ">
                <div class="row">
                    ...
                    if ($_SESSION['fonction']=="daf" OR $_SESSION['fonction']=="administrateur")
                    {
                        ...
                        ?>
                        <a href="banque_2.php" class="btn col s8 m3 l2 offset-s1 offset-m1 ">Nouvelle opération</a>
                        <?php
                            
                    }
                    ?>
                    <a onclick="window.print()" href="" class="btn col s8 offset-s1  m2 offset-m1">Imprimer</a>
                    <a href="etat_banque_journalier_2.php" class="btn col s8 m3 l2 offset-s3  offset-m1 offset-l1">Banque journalière BAS</a>
                ...
                <div class="row" style="margin-top:-20px;">
                    <h4 class="center white-text" >Grand livre banque BAS du mois de</h4>
                    <h5 class="row">
