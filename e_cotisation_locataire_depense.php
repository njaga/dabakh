...
<html>
	<head>
		<title>Cotisaitions pour logements des bailleurs</title>
	...
	<body style="background-image: url(<?= $image ?>bgaccueil.jpg);">
		...
		?>
		<div class="row">
			<h4 class="center col s12 white-text" >Cotisaitions pour logements des bailleurs </h4>
				...
				<table class="bordered highlight centered striped col s12">
					<thead>
						<tr style="color: #fff; background-color: #bd8a3e">
							...
							<th data-field="tel">Montant encaissé</th>
							<th ></th>
						</tr>
					</thead>
					<tbody>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			function l_bailleurs(search) {
				$.ajax({
					type:'POST',
					url:'e_cotisation_locataire_depense_ajax.php',
					data:'search='+search,
