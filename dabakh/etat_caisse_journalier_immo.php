...
<html>
    ...
    <body style="background-color: white">
        ...
        <form action="excel_caisse_immo.php" method="post">
            <div class="row">
                ...
                <h4 class="center" style="color: #0d47a1">Journal de la caisse</h4>
            </div>
            <h5 class="row">
                <div class="col s4 m2 offset-m3 input-field">
            ...
            <table class="col s12 m12 l12">
                <thead>
                    <tr style="color: #fff; background-color: #bd8a3e">
                        ...
                        <th data-field="" class="trait">PJ&nbsp&nbsp</th>
    ...
    $.ajax({
    type: 'POST',
    url: 'etat_caisse_journalier_immo_ajax.php',
