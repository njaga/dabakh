				...
				<table class="bordered highlight centered striped">
					...
					<tbody>
						...
						echo "<tr>";
							...
							echo "<td><a class='' href='detail_logement.php?id=".$id_logement."' >Détails</a><br>
									  <a class='btn cyan' href='m_logement_bailleur.php?id=".$id_logement."'>Déplacer</a>
								</td>";
			...
			<div class="col s12   ">
				<table class="bordered highlight centered striped">
					...
					<tbody>
						...
						$id_locataire=$donnees['4'];							
						echo "<tr>";
						$i=$i+1;
							echo "<td class=' grey white-text'><a class='btn' href='i_contrat_location.php?id=".$id."'>".($i)."</a>&nbsp&nbsp";
							echo "<a  class='tooltipped btn brown' data-position='top' data-delay='50' data-tooltip='Consulter le dossier' href='infos_mens_loc.php?id=".$id_locataire."'><i class='material-icons'>folder_open</i>
					</a></td>";
