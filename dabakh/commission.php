    ...
    <div class="row">
        ...
        <div class="col s12   ">
            <div class="row">
                ...
                <a onclick="window.print()" href="statistique_commission.php" class="btn col s3 m3 offset-m2 offset-s1">Statistiques</a>
                <a onclick="window.print()" href="" class="btn col s3 m2 offset-m3 offset-s1">Imprimer</a>
            </div>
