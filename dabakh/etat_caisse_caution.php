    ...
    <div class="row">
        ...
        <div class="col s12 m12   ">
            <div class="row">
                ...
                <a href="e_caisse_caution_locataire.php" class="btn col s3 offset-s1 ">Nouvelle opération</a>
                <a href="e_versement_bailleur.php" class="btn col s3 offset-s1 ">Caution bailleur</a>
                <br>
