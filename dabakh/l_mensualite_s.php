...
<html>
	<head>
		<title>Liste mensualités supprimées</title>
	...
	<body id="debut" style="background-image: url(<?= $image ?>bgaccueil.jpg);">
		...
		<div class="row">
			<h4 class="center #0d47a1 col s12" style="color: white">Mensualités supprimées du mois de :</h4>
			<h5><select class="browser-default col s6 offset-s3 m3 offset-m5 l2 offset-l5" name="mois" class="mois" style="background-color: white;">
				<?php
				for ($i=1; $i <= 12; $i++) {
