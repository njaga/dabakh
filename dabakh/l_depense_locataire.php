...
$annee=date("Y");
$req=$db->query('SELECT DISTINCT YEAR(date_depense) FROM `depense_locataire`');
...
<html>
	...
	<body style="background-image: url(<?= $image ?>bgaccueil.jpg);">
		...
		<div class="row">
			<a class="btn col s8 m2 " href="e_depense_locataire.php">Nouvelle cotisation</a>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			function l_depense_bailleur()
			{
				...
				$.ajax({
				type:'POST',
				url:'l_depense_locataire_ajax.php',
