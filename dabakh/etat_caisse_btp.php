...
$datefr = $mois[date("n")];
$req_annee=$db->query('SELECT DISTINCT YEAR(date_operation) FROM `caisse_btp` ORDER BY date_operation DESC');
        ...
        <div class="row page">
            ...
            <div class="col s12   ">
                <div class="row">
                    ...
                    {
                    ?>
                    <a href="e_caisse_btp.php" class="btn col s8 offset-s1 m4 offset-m1 l2 offset-l1 ">Nouvelle opération</a>
                    <?php
                    }
                    ?>
                    <a href="etat_caisse_journalier_btp.php" class="btn col s8 offset-s3  m4 offset-m1 l2 offset-l1">Caisse journalière</a>
                ...
                <div class="row" style="margin-top:-20px;">
                    <h4 class="center" style="color: #0d47a1; ">Grand livre caisse BTP du mois de</h4>
                    <h5 class="row">
