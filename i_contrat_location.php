        ...
        <div class="row">
            <div class="col s12" style="font: 12pt 'times new roman';">
                ...
                <div class="col s12">
                    ...
                    <br>
                    Le présent bail est consenti moyennant un loyer mensuel de <b><?= $pu +$tlv + $tom ?></b> F TTC, payable avant le cinq (05) de chaque mois entamé, ainsi décomposé :
                    <div class="row">
                        <table class=" ">
                            <tr>
                                <td>Loyer HT </td>
                                <td><b><?= $pu  ?></b> FCFA/mois</td>
                            </tr>
                            <tr>
                                <td>TOM 3.6%</td>
                                <td><b><?= $tom ?></b> FCFA/mois</td>
                            </tr>
                            <tr>
                                <td>TLV 2%</td>
                                <td><b><?= $tlv ?></b> FCFA/mois</td>
                            </tr>

                            <tr>
                                <td>Total loyer TTC</td>
                                <td><b><?= $pu +$tlv +$tom ?></b> FCFA/mois</td>
                            </tr>
                        </table>
                    </div>
                    <br>
                    ...
                    <br>
                    <b>4-b</b>- Commission au profit de la société immobilière Carré d'Or SAS.
                    <br>
                    Outre le loyer mensuel payable d’avance, le preneur versera également au profit de la <b>Société Carré d'Or SAS </b> une commission égale à un mois de loyer TTC, soit la somme de : <b><?= $pu +$tlv +$tom ?></b> F CFA.
                    <br>
                    <b>4-c</b>- Caution de garantie
                    <br>
                    Le preneur versera la somme de <b><?= $pu +$tlv +$tom ?></b> FCFA , représentant <b><?= $nbr_mois ?></b> mois de caution, non productible d’intérêts pour la garantie de l’entretien et des réparations locatives incombant au preneur.
                    <br>
