...
$req_annee=$db->query('SELECT DISTINCT annee FROM `mensualite_bailleur` ORDER BY annee ASC');
$annee= date('Y');
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Statitique commission</title>
  <!-- MDB icon -->
...
<body>
  ...
  <div class="container">
    ...
    <div class="row">
      <h2 class="col-md-12 center"><b>Statistique des commisions</b></h2>
    </div>
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      function statistique()
      {
        ...
        $.ajax({
        type:'POST',
        url:'statistique_commission_ajax.php',
        data:'annee='+annee,
