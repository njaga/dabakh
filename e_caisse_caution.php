...
$req=$db->prepare("SELECT location.id, locataire.prenom, locataire.nom, caisse_caution.montant
FROM `caisse_caution`
RIGHT JOIN location ON caisse_caution.id_location=location.id
    ...
    <div class="container white">
        ...
        <div class="row z-depth-5" style="padding: 10px;">
            ...
            <h4 class="center">
                ...
                <br>
                Montant caution : <b><?=number_format($caution,0,'.',' ') ?> Fcfa</b>
            </h4>
