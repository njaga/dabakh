...
$req=$db->prepare('SELECT CONCAT(patient.prenom," ", patient.nom), certificat_hospitalisation.date_certificat, certificat_hospitalisation.date_debut , certificat_hospitalisation.date_fin, certificat_hospitalisation.nbr_jours
FROM certificat_hospitalisation
INNER JOIN patient ON patient.id_patient=certificat_hospitalisation.id_patient 
WHERE certificat_hospitalisation.id=?');
...
<body style="background-image: url(<?= $image ?>bgaccueil.jpg);">
    ...
    <div class="container white">
        ...
        <div class="row z-depth-5" style="padding: 10px;">
            <h3 class="center">Modification d'un certificat d'hospitalisation</h3>
            <form class="col s12" method="POST" id="form" action="m_certificat_hos_trmnt.php?id=<?=$_GET['id'] ?>">
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col s3 input-field">
                        <input type="text" class="datepicker" value="<?= $date_fin ?>"name="date_fin" id="date_fin" required>
