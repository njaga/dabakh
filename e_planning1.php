	...
	<body style="background-image: url(<?= $image ?>bgaccueil.jpg);">
		...
		<div class="container white">
			<div class="row z-depth-5" style="padding: 10px;">
				<h3 class="center">Planning de recouvrement du <b><?=$date_planning_debut ?> AU <?=$date_planning_fin ?></b></h3>
					...
					<div class="row">
                        ...
                        <a href="l_planning_recouv.php" class="btn">Enregistrer</a>
						</div>
					</div>
				</form>
			</div>
	...
	<script type="text/javascript">
		$(document).ready(function () {
			...
			$('#form').submit(function () {
				if (!confirm('Voulez-vous confirmer l\'enregistrement de ce planning ?')) {
					return false;
				}
            });
