...
$req=$db->prepare('SELECT caisse_depot.motif, caisse_depot.date_operation, caisse_depot.montant, caisse_depot.type
FROM `caisse_depot`
WHERE caisse_depot.id=?');
...
<body style="background-image: url(<?= $image ?>bgaccueil.jpg);">
    ...
    <div class="container white">
        <div class="row z-depth-5" style="padding: 10px;">
            ...
            <form class="col s12" method="POST" id="form" action="m_caisse_depot_trmnt.php?id=<?=$_GET['id']?>">
                <div class="row">
