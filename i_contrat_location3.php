        ...
        <div class="row">
            <div class="col s12" style="font: 12pt 'times new roman';">
                ...
                <div class="col s12">
                    ...
                    <br>
                    <br>
                    Chaque jour de retard est passible de frais d'un montant de <b>deux mille cinq cent (2.500)</b> par jour. Tous les paiements doivent être effectués au siege de l'agence par chèque, espèce ou virement (dans ce cas le numéro de compte vous sera communiqué) <b>au plus le 05 de chaque mois</b>.
                    <br>
